  ...
  return (
    <section className="bg-customText2">
      <div className="text-center mx-2 py-20 ">
        ...
        في هاي فايف بروبرتيز، نقدم أناقة لا مثيل لها من خلال دمج الفخامة، والتصميم الراقي، والأسلوب الخالد بسلاسة، مما يضمن أن كل واحدة من عقاراتنا توفر تجربة سكنية استثنائية.
        </p>
      </div>
      <Swipper />
    </section>
